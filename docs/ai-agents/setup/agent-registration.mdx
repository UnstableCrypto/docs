...
A Basename gives your agent a human-readable identity (e.g., `myagent.base.eth`) that resolves to its wallet address. Register at [unstable.org/names](https://www.unstable.org/names).
