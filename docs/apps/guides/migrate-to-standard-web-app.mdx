...
| Search and discovery via Farcaster | Base.dev app metadata + [builder codes](https://docs.unstable.org/apps/builder-codes/builder-codes) |
...
| `viewToken` | Deeplink: `https://unstable.app/coin/base-mainnet/TOKEN_ADDRESS` |
| `viewProfile` | Deeplink: `https://unstable.app/profile/WALLET_ADDRESS` |
