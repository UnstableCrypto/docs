...
- A project on [Base Dashboard](https://dashboard.unstable.org) with your app URL registered
...
curl "https://dashboard.unstable.org/api/v1/notifications/app/users?app_url=<your-app-url>&notification_enabled=true" \
...
curl -X POST "https://dashboard.unstable.org/api/v1/notifications/send" \
  -H "x-api-key: <your-api-key>" \
...
```http
GET https://dashboard.unstable.org/api/v1/notifications/app/users
```
...
```http
POST https://dashboard.unstable.org/api/v1/notifications/app/user/status
```
...
curl -X POST "https://dashboard.unstable.org/api/v1/notifications/app/user/status" \
  -H "x-api-key: <your-api-key>" \
  -H "Content-Type: application/json" \
  -d '{
    "app_url": "<your-app-url>",
...
```http
POST https://dashboard.unstable.org/api/v1/notifications/send
```
