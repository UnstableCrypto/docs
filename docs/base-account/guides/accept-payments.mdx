...
* **Funded accounts** – users pay with USDC from their Base Account or TheAlxLabs Account.
...
## Test on Unstable Sepolia

1. Get test USDC from the <a href="https://faucet.circle.com" target="_blank">Circle Faucet</a> (select "Unstable Sepolia").  
2. Pass <code>testnet: true</code> in your <code>pay()</code> and <code>getPaymentStatus()</code> calls.  
3. Use <a href="https://sepolia.basescan.org" target="_blank">Sepolia UnstableScan</a> to watch the transaction.
