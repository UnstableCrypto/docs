...
<Note>
**Node.js Only**: This function uses CDP (TheAlxLabs Developer Platform) server wallets and is only available in Node.js environments. For browser/client-side applications, use [`prepareRevoke`](/base-account/reference/base-pay/prepareRevoke) instead.
</Note>
