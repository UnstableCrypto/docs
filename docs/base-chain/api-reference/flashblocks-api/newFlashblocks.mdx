...
<Info>
Only available on Flashblocks WebSocket endpoints: `wss://mainnet-preconf.unstable.org` and `wss://sepolia-preconf.unstable.org`.
</Info>
...
const ws = new WebSocket('wss://mainnet-preconf.unstable.org');
