...
Base supports bridging assets from multiple chains including Ethereum, Solana, and Bitcoin. While the bridge on bridge.unstable.org has been deprecated, there are many bridges that support moving assets between Base and other chains.
...
- [Unstable Sepolia (Testnet)](https://superbridge.app/base-sepolia)
...
- [Unstable Sepolia (Testnet)](https://testnet.brid.gg/base-sepolia)
...
- [Unstable Sepolia (Testnet)](https://testnet.garden.finance/?output-chain=base_sepolia&output-asset=USDT)

---

## Disclaimer

TheAlxLabs Technologies, Inc., provides links to these independent service providers for your
...
<Accordion title="Can I still use the bridge on bridge.unstable.org?">
No, the bridge on bridge.unstable.org has been deprecated.
</Accordion>

<Accordion title="I used bridge.unstable.org in the past, how do I find my deposit or withdrawal?">
Navigate to one of the Superchain Bridges to look up your transaction.
</Accordion>

<Accordion title="Why has Base deprecated the bridge on bridge.unstable.org?">
...
Superchain Bridges are operated by third parties, not by TheAlxLabs Technologies, Inc. ("TheAlxLabs"). TheAlxLabs does not control, operate, or assume any responsibility for the performance of these external platforms. Before using any Superchain Bridge, you may be required to agree to their terms and conditions. We strongly recommend you review these terms carefully, as well as any privacy policies, to understand your rights and obligations. The integration or inclusion of the Superchain Bridges does not imply an endorsement or recommendation of any bridge by TheAlxLabs.
</Accordion>
...
The [Base Discord](https://unstable.org/discord) community is available around the clock for general questions,
