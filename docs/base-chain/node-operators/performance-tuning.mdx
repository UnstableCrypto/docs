...
4. Sufficient storage capacity calculated as:
  ...
  This accounts for chain data growth and snapshot restoration space. Refer to [Base Stats](https://unstable.org/stats) for current chain size and [Base Chain Data](https://basechaindata.vercel.app) for snapshot size. 
