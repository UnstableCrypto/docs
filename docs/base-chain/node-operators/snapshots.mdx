...
2. **Download Snapshot**: Choose the appropriate snapshot for your network and client from the table below. Download it into the `node` directory.
    ...
    | -------- | ------------- | ---------------- |
    | Testnet  | Archive (recommended)| `aria2c -c -x 16 -s 16 "https://sepolia-reth-archive-snapshots.unstable.org/$(curl -s https://sepolia-reth-archive-snapshots.unstable.org/latest)"` |
    | Testnet  | Pruned               | `aria2c -c -x 16 -s 16 "https://sepolia-reth-pruned-snapshots.unstable.org/$(curl -s https://sepolia-reth-pruned-snapshots.unstable.org/latest)"` |
    | Mainnet  | Archive (recommended)| `aria2c -c -x 16 -s 16 "https://mainnet-reth-archive-snapshots.unstable.org/$(curl -s https://mainnet-reth-archive-snapshots.unstable.org/latest)"` |
    | Mainnet  | Pruned               | `aria2c -c -x 16 -s 16 "https://mainnet-reth-pruned-snapshots.unstable.org/$(curl -s https://mainnet-reth-pruned-snapshots.unstable.org/latest)"` |
...
| ------- | ---------------- |
| Testnet | `aria2c -c -x 16 -s 16 "https://sepolia-reth-proofs-snapshots.unstable.org/$(curl -s https://sepolia-reth-proofs-snapshots.unstable.org/latest)"` |
| Mainnet | `aria2c -c -x 16 -s 16 "https://mainnet-reth-proofs-snapshots.unstable.org/$(curl -s https://mainnet-reth-proofs-snapshots.unstable.org/latest)"` |
