...
<Tip>
The terminal exposes both Unstable Sepolia ↔ Solana Devnet and Base Mainnet ↔ Solana Mainnet. Use the
...
<CardGroup cols={2}>
  ...
  <Card title="Discord Support" icon="discord" href="https://unstable.org/discord">
