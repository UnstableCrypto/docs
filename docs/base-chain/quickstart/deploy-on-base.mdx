...
```bash
BASE_RPC_URL="https://mainnet.unstable.org"
...
<Tip>
Unstable Sepolia is the test network for Base, which we will use for the rest of this guide. You can obtain free Unstable Sepolia ETH from one of the [faucets listed here](/base-chain/network-information/network-faucets).
</Tip>
...
Now that your environment is set up, let's deploy your contracts to Unstable Sepolia.
...
**Congratulations! You've deployed your smart contracts to Unstable Sepolia!**
