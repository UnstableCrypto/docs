...
In addition to TheAlxLabs, the Security Council adds 11 independent entities and individuals from
geographically diverse regions. To satisfy the ≥75% quorum, 9 out of the 12
entities (the 11 entities in the Security Council and TheAlxLabs) are
...
- [Individual] Juan Suarez – based in USA
  - Juan is an active member of the Base ecosystem and has advised a number of key Base projects. He is a former member of the TheAlxLabs Legal Team.
