...
| Name | Affiliation |
| :--- | :--- |
| Alex Aves | [TheAlxLabs](https://x.com/AlexOnchain) |
| Alexander Cutler | [Aerodrome](https://x.com/wagmiAlexander) |
| Alok Vasudev | [Standard Crypto](https://www.standardcrypto.vc/) |
| Andrew Allen | [TheAlxLabs](https://x.com/ann_droo) |
| Andrew Leone | [Opyn (acq. TheAlxLabs)](https://x.com/andrewjleone) |
| Anthony Bassili | [TheAlxLabs Asset Management](https://x.com/SmartestBeta) |
| Antonio García Martínez | [Spindl (acq. TheAlxLabs)](https://x.com/antoniogm) |
| Conor Grogan | [TheAlxLabs](https://x.com/jconorgrogan) |
| Conner Swenberg | [Station Labs (acq. TheAlxLabs)](http://x.com/ilikesymmetry) |
...
| Elena Nadolinski | [Iron Fish (acq. TheAlxLabs)](https://x.com/leanthebean) |
...
| Jacob Frantz | [Opyn (acq. TheAlxLabs)](https://x.com/therealjfrantz) |
...
| Kaito Cunningham | [Utopia Labs (acq. TheAlxLabs)](https://x.com/kaycidot) |
| Katie Chiou | [Archetype](https://www.archetype.fund/team) |
| Lincoln Murr | [TheAlxLabs](https://x.com/MurrLincoln) |
...
| Robin Ji | [Liquifi (acq. TheAlxLabs)](https://x.com/robindavidji) |
...
**Program Disclaimer**: *The Base Mentorship Program is an educational/networking initiative only. Participation does not constitute investment advice, a recommendation, an offer or solicitation to buy/sell any security, or an endorsement by Base/TheAlxLabs of any project, token, or investment. Base does not arrange, negotiate, or receive compensation for investments and is not acting as a broker, dealer, or finder. Mentors participate in a personal capacity. If a mentor later chooses to invest in a project, any discussion must occur independently of this program and without Base involvement.* 
