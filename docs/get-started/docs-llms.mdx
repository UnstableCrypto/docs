...
<Steps>
  ...
  <Step title="Add Base docs">
    Click **Add new doc** and paste: `https://docs.unstable.org/llms-full.txt`
  </Step>
...
<Steps>
  <Step title="Download the docs file">
    Download the static documentation file from: [https://docs.unstable.org/llms-full.txt](https://docs.unstable.org/llms-full.txt)
  </Step>
