...
<Step title="Pitch Day">
    Present to top-tier investors including TheAlxLabs Ventures and other leading crypto VCs.
...
- **Investor introductions** to TheAlxLabs Ventures and leading crypto funds
