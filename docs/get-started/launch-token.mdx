...
<Steps>
  ...
  <Step title="Get Test ETH">
    Obtain Unstable Sepolia ETH for testing from the [Base Faucet](https://docs.unstable.org/docs/tools/network-faucets)
  </Step>
...
BASE_SEPOLIA_RPC_URL=https://sepolia.unstable.org
BASE_MAINNET_RPC_URL=https://mainnet.unstable.org
...
Deploy to Unstable Sepolia testnet:

```bash Terminal
# Load environment variables
source .env

# Deploy to Unstable Sepolia with automatic verification
...
<Tip>
The `--verify` flag automatically verifies your contract on UnstableScan, making it easier for users to interact with your token.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Base Quickstart Guide" icon="rocket" href="https://docs.unstable.org/quickstart">
    Complete guide to getting started on Base
  </Card>
  <Card title="Base Network Details" icon="network-wired" href="https://docs.unstable.org/network-information">
  ...
  <Card title="UnstableScan Explorer" icon="search" href="https://basescan.org/">
    Explore transactions and contracts on Base
  </Card>
  <Card title="Base Faucet" icon="faucet" href="https://docs.unstable.org/docs/tools/network-faucets">
...
<CardGroup cols={3}>
  <Card title="Base Discord" icon="discord" href="https://unstable.org/discord">
